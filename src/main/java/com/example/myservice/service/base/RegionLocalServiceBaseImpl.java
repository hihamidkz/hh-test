...
import com.example.myservice.service.RegionLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.example.myservice.service.impl.RegionLocalServiceImpl}.
 * </p>
 *
 * @author hamid
...
public abstract class RegionLocalServiceBaseImpl extends BaseLocalServiceImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.example.myservice.service.RegionLocalServiceUtil} to access the region local service.
     */
     ...
     */
    @Override
    public Region createRegion(long id) {
        return regionPersistence.create(id);
    }
    ...
    @Override
    public Region deleteRegion(long id) throws PortalException, SystemException {
        return regionPersistence.remove(id);
    }
    ...
    @Override
    public Region fetchRegion(long id) throws SystemException {
        return regionPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Region getRegion(long id) throws PortalException, SystemException {
        return regionPersistence.findByPrimaryKey(id);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.example.myservice.model.Region",
            regionLocalService);
    }
